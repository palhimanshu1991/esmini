	...
	*/
	...
	public:
		...
		RMObject(double s, double t, int id, std::string name, Orientation orientation, double z_offset, ObjectType type,
				 double length, double height, double width, double heading, double pitch, double roll) : s_(s), t_(t), id_(id), name_(name), orientation_(orientation), z_offset_(z_offset), type_(type),
